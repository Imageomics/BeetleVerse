# Domain Shift · NHMC-I1MC-species

**Lab → in-situ** transfer at species level: train on museum specimens, test on in-situ field photographs.

| | Dataset | Split file | Rows |
|---|---|---|--:|
| **Train (source)** | NHM-Carabids | `train.csv` | 20,466 |
| **Test (target)** | Insect-1M carabids | `test.csv` | 777 |
